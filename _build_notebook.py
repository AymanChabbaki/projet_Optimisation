"""
Generates  edge_ai_pipeline.ipynb  from inline cell definitions.
...
def src(text: str):
    """Convert a multiline string into a source-lines list."""
    lines = text.splitlines(keepends=True)
    if lines and not lines[-1].endswith("\n"):
        pass  # last line needs no trailing \n
    return lines
